...
const QuantityCard = ({ title, image, number, type, cardMedidPerson, update ,link}) => {
    ...
    return (
        <NavLink className={`quantity-card ${cardMedidPerson} d-flex align-items-center`} to={link}>
            <div className="d-flex align-items-center px-0 w-100">
                ...
                <div className="quantity-card__content px-1 text-center col-9">
                    <p className={`quantity-card__title mb-0 d-flex justify-content-center text-dark`}>{title}</p>
